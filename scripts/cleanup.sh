...
echo "   PREFIX: ${PREFIX}"
echo ""
echo "ADVERTENCIA: Esto eliminará TODOS los recursos del lab"
...
# ============================================================================
echo "Paso 1/8: Eliminando ambiente MWAA..."
...
# ============================================================================
echo "Paso 2/8: Eliminando Glue Job..."
...
# ============================================================================
echo "Paso 3/8: Eliminando Glue Crawlers..."
...
if aws glue get-crawler --name ${PROCESSED_CRAWLER} --region ${REGION} 2>/dev/null; then
    ...
    echo "No se encontró crawler processed"
fi
echo ""
...
# ============================================================================
echo "Paso 4/8: Eliminando tablas de Glue Data Catalog..."
...
# ============================================================================
echo "Paso 5/8: Eliminando base de datos de Glue..."
...
# ============================================================================
echo "Paso 6/8: Eliminando SNS Topic..."
...
# ============================================================================
echo "Paso 7/8: Eliminando roles IAM..."
...
# ============================================================================
echo "Paso 8/8: Eliminando buckets de S3..."
...
for bucket in "${BUCKETS[@]}"; do
    if aws s3 ls s3://${bucket} 2>/dev/null; then
        ...
        echo "No se encontró bucket: ${bucket}"
    fi
done
echo ""
